...
#---------------------------------------------------------------------------#
# Code inspiré de https://docs.opencv.org/4.x/da/de9/tutorial_py_epipolar_geometry.html
#---------------------------------------------------------------------------#

def miseEnCorrespondance(path_image, F):

    print("#---------------------------------------------------------------------------#")
    print("# ----------------- Début de la mise en correspondance ----------------------")
    print("#---------------------------------------------------------------------------#")

    images = glob.glob("./" + path_image + "/*.jpg")
...
def drawlines(img1,img2,lines,pts1,pts2):
    ''' img1 - image on which we draw the epilines for the points in img_d
